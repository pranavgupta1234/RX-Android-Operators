...
public class IntervalOperator extends BaseActivity {
    ...
    private Observable<Long> interval() {
        /**Returns an observable which emits sequential numbers after given interval
         * */
        return Observable.interval(1, TimeUnit.SECONDS)
        //interval operates by default on the computation Scheduler,so observe on main Thread
